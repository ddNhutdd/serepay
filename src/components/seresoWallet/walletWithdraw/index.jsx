...
function FormWithdraw() {
  ...
  // phần history
  const [callApiHistoryStatus, setCallApiHistoryStatus] = useState(api_status.pending);
  ...
  const renderHistoryContent = () => {
    return callApiHistoryStatus !== api_status.fetching && withdrawHistory && withdrawHistory.length > 0 ? '' : '--d-none';
  }
